        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorLevel = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorAddress", x => x.AddressID);
                    table.ForeignKey(
                        name: "FK_AuthorAddress_Authors_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorAddress_AuthorId",
                table: "AuthorAddress",
                column: "AuthorId");
